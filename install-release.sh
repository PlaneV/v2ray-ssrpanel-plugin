...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/PlaneV/v2ray-ssrpanel-plugin/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/PlaneV/v2ray-ssrpanel-plugin/releases"
